...
async def on_message(message):
    ...
    if message.content.startswith('g!link'):
        ...
        await message.channel.send('Youtube: https://www.youtube.com/channel/UC014Q9AuEzn-ncArNGdQhZA')
        await message.channel.send('Projeto Fnaf: https://www.youtube.com/channel/UCWZ0xPHFdbh2N6Ibb5n5fVQ')
        await message.channel.send('Twich: https://www.twitch.tv/gustavohsg6craft')
        await message.channel.send('Discord Age SMP: https://discord.gg/JHacVRqWd5')
        await message.channel.send('Discord Projeto Fnaf: https://discord.gg/8rVFAsdkqg')
